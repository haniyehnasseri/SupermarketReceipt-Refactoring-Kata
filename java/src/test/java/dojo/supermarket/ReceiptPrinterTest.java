...
public class ReceiptPrinterTest {
    ...
    public void quantityTwo() {
        receipt.addProduct(toothbrush, 2,0.99 * 2);
        Approvals.verify(new ReceiptPrinter(40).printReceipt(receipt));
    }

    @Test
    public void looseWeight() {
        receipt.addProduct(apples, 2.3,1.99 * 2.3);
        Approvals.verify(new ReceiptPrinter(40).printReceipt(receipt));
    }
    ...
    public void total() {
        ...
        receipt.addProduct(toothbrush, 1, 2*0.99);
        receipt.addProduct(apples, 0.75, 1.99*0.75);
        Approvals.verify(new ReceiptPrinter(40).printReceipt(receipt));
    }
    ...
    public void printWholeReceipt() {
        receipt.addProduct(toothbrush, 1, 0.99);
        receipt.addProduct(toothbrush, 2,2*0.99);
        receipt.addProduct(apples, 0.75,1.99*0.75);
